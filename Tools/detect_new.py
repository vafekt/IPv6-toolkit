...
def main():
    ...
    parser.add_argument("-t", dest='time', type=int, help="the interval in seconds lasting this attack.")
    ...
    def custom_action(packet):
        ...
        if packet[0][1].src == "::":
            if packet[0][ICMPv6ND_NS].tgt not in ip_list:  # Deleting duplicate address when capturing
                ...
                return f"Detected IPv6 address number #{sum(packet_counts.values())}: " \
