...
def parameter():
    ...
    return args.interface, args.source_mac, args.source_ip, args.destination_ip, content


def generate(interface, source_mac, source_ip, destination_ip, content):
...
def execute_functions(interface, source_mac, source_ip, destination_ip, content):
    p1 = multiprocessing.Process(target=generate, args=[interface, source_mac, source_ip, destination_ip, content])
...
if __name__ == "__main__":
    ...
    interface, source_mac, source_ip, destination_ip, content = parameter()
    try:
        execute_functions(interface, source_mac, source_ip, destination_ip, content)
    except KeyboardInterrupt:
        sys.exit(0)
